...
const homepageFaqs = [
  {
    ...
    a: 'AI search readiness measures how well your web content is optimized for citation and extraction by AI systems like ChatGPT, Perplexity, Google AI Overviews, and Gemini. Our audit analyzes 50+ factors across 6 categories: Structure & Hierarchy (heading organization), Schema Markup (JSON-LD implementation), Content Extractability (section length and clarity), FAQ & Q&A Blocks (structured questions and answers), Trust & Authority (author credentials and citations), and Technical Readability (meta tags and robots directives). Each factor influences whether AI systems discover, understand, and cite your content.',
  },
  {
    q: 'Why does this matter?',
    a: 'AI search systems are fundamentally reshaping how people discover information. Unlike Google, which ranks pages based on links and keywords, AI systems extract and cite content based on structure, schema markup, and extractability. If your content isn\'t optimized for AI extraction, you\'re missing visibility with ChatGPT, Perplexity, and Google AI Overviews—platforms that millions of users rely on daily. Even high-ranking pages in traditional Google search can be overlooked by AI systems if they\'re not properly structured. Our tool identifies these optimization gaps so you can fix them.',
  },
  {
    q: 'Is the audit free?',
    a: 'Yes, completely free. No signup required, no credit card needed, no limits on audits. We believe everyone—from individual bloggers to large publishers—should have access to AI search optimization tools without paywalls. Our mission is making AI search readiness transparent and accessible to all creators, regardless of technical background or budget.',
  },
  {
    q: 'What will I learn?',
    a: 'You\'ll receive a comprehensive AI Readiness score (0-100) with a letter grade (A-F), detailed breakdowns showing your performance in each of the 6 categories, and a prioritized action plan with 15+ specific recommendations. Recommendations are organized by impact level (High, Medium, Low) and effort required (Quick Wins, High Impact, Long Term), so you can focus on changes that move the needle most. Each recommendation includes an explanation of why it matters for AI systems and step-by-step guidance to implement it.',
  },
];
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <div className="text-left space-y-2">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-500">
                  Published: April 15, 2026 | Last Updated: April 29, 2026 | Version 1.0
                </p>
              </div>
